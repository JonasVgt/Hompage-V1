...
<footer>
    ...
    <div  class="footer-part">
        <a div class="hidden-link" href="/Projects/projectList.php">PROJECTS</a> |
        <a div class="hidden-link" href="/privacy.php">ABOUT ME</a> |
        <a div class="hidden-link" href="/privacy.php">CONTACT</a>

    </div>
    <p id="copyright"><a class="hidden-link" href="/index.php">&copy; 2020: Jonas Voigt</a></p>
